...
### Inglish No Console e Apps
Os textos que coloco no gui do **Claude** são em inglês, para evitar que a ferramenta faça tradução porterior do português para o inglês (acho que isso consome token).

### Salvando Tokens
Sempre tento ser suscinto para evitar gastar tokens à toa.

Exemplo, para melhorar um README.md, prefiro.
```
update README.md
```
A escrever:
```
update README.md to better explain what the project is about
```
